...
$sql = "CREATE TABLE IF NOT EXISTS `mystation` (`ID` int(11) NOT NULL AUTO_INCREMENT, 
  ...
  `WindDirOutCur` decimal(4,1) NOT NULL COMMENT 'Current Outdoor Wind Direction',
   PRIMARY KEY (ID));";
...
$sql = "INSERT INTO `mystation` (`DateTime`, `TempOutCur`, `HumOutCur`, `PressOutCur`, `WindOutCur`, `WindDirOutCur`) VALUES
('$DateTime', $Temp, $Humidity, $Pressure, $Wind, $WindDir);";
